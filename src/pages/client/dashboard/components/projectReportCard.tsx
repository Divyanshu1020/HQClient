...
const chartData = [
  { browser: "Completed", visitors: 56, fill: "#7E065C" },
  { browser: "safari", visitors: 12, fill: "#BE198F" },
  { browser: "firefox", visitors: 12, fill: "#F65BCA" },
  { browser: "edge", visitors: 3, fill: "#FFB7EA" },
];
            ...
            <div className=" flex flex-col font-medium text-lg w-full ">
              <div className="flex flex-row  items-center justify-between ">
                <div className="flex flex-row items-center gap-5">
                  <div className="h-4 w-4 rounded-full bg-[#7E065C]"></div>
              ...
              <div className="flex flex-row items-center justify-between ">
                <div className="flex flex-row items-center gap-5">
                  <div className="h-4 w-4 rounded-full bg-[#BE198F]"></div>
              ...
              <div className="flex flex-row items-center justify-between ">
                <div className="flex flex-row items-center gap-5">
                  <div className="h-4 w-4 rounded-full bg-[#F65BCA]"></div>
              ...
              <div className="flex flex-row items-center justify-between ">
                <div className="flex flex-row items-center gap-5">
                  <div className="h-4 w-4 rounded-full bg-[#FFB7EA]"></div>
