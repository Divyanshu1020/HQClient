...
export default function Figma() {
    const [isFigmaDesignChatOpen, setIsFigmaDesignChatOpen] = useState(true);
  return (
          ...
          <div className=" w-full h-full flex flex-row overflow-hidden ">
            <div
              className={`relative transition-all ease-in-out duration-300   h-full ${
                isFigmaDesignChatOpen ? "hidden" : "block"
              } w-fit lg:block   rounded-[50px] shadow_figma_design_image overflow-hidden ${
                isFigmaDesignChatOpen ? " lg:min-w-[60%]  " : "min-w-[100%]"
              } `}
            >
              <img
              ...
              <div className="absolute left-[45px] bottom-[35px] flex flex-row gap-4 ">
                ...
                <div
                  onClick={() =>
                    setIsFigmaDesignChatOpen(!isFigmaDesignChatOpen)
                  }
            ...
            <div
              className={`  h-full  w-full flex flex-col gap-4 p-3 sm:p-4 md:p-5 lg:p-6 ${
                isFigmaDesignChatOpen ? "min-w-[40%]" : "hidden"
              } `}
            >
              <div className="w-full flex flex-row items-center justify-between px-6 py-4 sm:p-0 ">
                <h1 className="text-2xl font-normal">Comments</h1>
                <div className="flex flex-row items-center cursor-pointer ">
                  <X
                    onClick={() => setIsFigmaDesignChatOpen(false)}
                    size={37}
                  />
                </div>
              </div>
